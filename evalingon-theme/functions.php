...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('smoothscroll', get_template_directory_uri() . '/js/lib/jquery.simplr.smoothscroll.min.js', array(), '2.7.1');
        wp_enqueue_script('smoothscroll'); // Enqueue it!
        
        wp_register_script('mousewheel', get_template_directory_uri() . '/js/lib/jquery.mousewheel.min.js', array(), '2.7.1');
...
{
    wp_register_style('normalize', get_template_directory_uri() . '/css/vendor.css', array(), '1.0', 'all');
...
/*------------------------------------*\
  Remove WP update admin notification
\*------------------------------------*/
